...
JEQ R0, R2, END // For conditions; Check x, GOTO program termination
JEQ R1, R2, INCX // Check y, GOTO incrementation of x
JEQ R0, R3, ZEROPIXEL // Process border pixel; If x = 0
JEQ R1, R3, ZEROPIXEL // If y = 0
JEQ R0, R4, ZEROPIXEL // If x = 255
JEQ R1, R4, ZEROPIXEL // If y = 255
MULI R5, R1, 20; // y * 20
ADD R6, R0, R5; // x + y * 200
LOAD R8, R6; // Get input image pixel
JEQ R8, R3, BLACK PIXEL; // Check if 0, GOTO pixel zerorising
SUBI R9, R0, 1 // x - 1
ADDI R10, R0, 1 // x + 1
SUBI R11, R1, 1 // y - 1
ADDI R12, R1, 1 // y + 1
...
JMP INCY; // Continue program after border process
